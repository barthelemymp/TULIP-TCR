#!/bin/bash
#SBATCH --job-name=gpu_gen20         # nom du job
...
#SBATCH --time=60:50:00              # temps maximum d'execution demande (HH:MM:SS)
#SBATCH --output=full.out      # nom du fichier de sortie
#SBATCH --error=full.err       # nom du fichier d'erreur (ici commun avec la sortie)
